...
enum RussianRegion {
    ...
    ROSTOV(61, new int[]{8, 23, 26, 34, 36, 114}, "z:\\osmtmp\\RU-ROS.o5m", true ),
    SEVASTOPOL(92, new int[]{82}, "z:\\osmtmp\\RU-SEV.o5m", true ),
    SIMFEROPOL(82, new int[]{92, 23, 114}, "z:\\osmtmp\\RU-CR.o5m", true ),
    ...
    NORG(101, new int[]{51}, "z:\\osmtmp\\RU-NIZ.o5m", false),
    FIN(102, new int[]{10, 47, 51}, "z:\\osmtmp\\RU-NIZ.o5m", false),

    EST(111, new int[]{47, 60}, "z:\\osmtmp\\RU-NIZ.o5m", false),
    LAT(112, new int[]{60}, "z:\\osmtmp\\RU-NIZ.o5m", false),
    BELARUS(113, new int[]{32, 60, 67}, "z:\\osmtmp\\RU-NIZ.o5m", false),
    UKR(114, new int[]{31, 32, 36, 46, 61}, "z:\\osmtmp\\RU-NIZ.o5m", false),

    GRU(121, new int[]{5, 6, 7, 9, 15, 20, 23}, "z:\\osmtmp\\RU-NIZ.o5m", false),
    AZER(122, new int[]{5}, "z:\\osmtmp\\RU-NIZ.o5m", false),

    KAZZ(131, new int[]{30, 34, 56, 63, 64}, "z:\\osmtmp\\RU-NIZ.o5m", false)
;
